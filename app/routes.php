...
Route::get('update-user/{id}/{title}/{name}/{email}/{birthMonth}/{birthDay}/{birthYear}/{password}', 'UserController@updateUser');
...
Route::get('get-library/{id}/{sortBy}/{sortOrder}/{page}/{limit}', 'LibraryController@getLibrary');
